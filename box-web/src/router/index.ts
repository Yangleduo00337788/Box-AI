  ...
  routes: [
    ...
    },
    {
      ...
      children: [
        ...
        { path: 'workflows', redirect: '/plugin-market?mine=workflows' },
        {
        ...
        { path: 'knowledge', redirect: '/plugin-market?mine=knowledge' },
        { path: 'tools', redirect: '/plugin-market?mine=tools' },
        { path: 'mcp', redirect: '/plugin-market?mine=mcp' },
